                            ...
                            dataProfile = [
                                {
                                    ...
                                    "header": {
                                        ...
                                        "contents": [
                                            {
                                                "type": "image",
                                                "url": 'https://www.img.in.th/images/d2a3be1c38a63e37d32acd25affec91e.jpg',
                                                "size": "xxl"
                                            },
                                            {
                                                "type": "text",
...
#=====================================================================
                ...
                if text.lower() == "ออน" or text.lower() == "runtime":
                    ...
                    gifnya = ["https://images.ru.prom.st/613622062_w640_h640_neonovaya-maska-sudnaya.jpg"]
                    data = {
                        "type": "template",
                        "altText": "กำลังรีบอท...",
                        "template": {
        ...
        if op.type == 25 or op.type == 26:
            ...
            if msg.contentType == 0:
                if text is None:
                    return
                if text.lower() == ".":
                    maxgie.sendMessage(to,"[ Prem Botline ]\nadmin :\nline://ti/p/~0830731525")
            elif cmd == '/คำสั่ง':
                sendflex(to,{"type":"flex","altText":"Flex Message","contents":{"type":"bubble","styles":{"body":{"backgroundColor":"#0000CC"}},"body":{"type":"box","layout":"vertical","contents":[{"type":"text","text":"〖 Group Welcome 〗\n\n• ชื่อกลุ่ม : ครอบครัว สาสเฟริส\n• ชื่อคนเข้ากลุ่ม : E R R O R  18 : 04\n\nยินดีต้อนรับเข้ากลุ่มนะครับ 😃","wrap":True,"color":"#66FFFF","align":"center","gravity":"center","size":"md"}]}}})
#========================================================================
            elif msg.contentType == 7: # Content type is sticker
                if settings['Sticker']:
                    if 'STKOPT' in msg.contentMetadata:
